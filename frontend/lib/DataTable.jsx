...
function DataRow({
  ...
  return (
    <tr
      ...
      className={css(
        styles.trBody,
        rowClickable && styles.trBodyClickable,
      )}
...
function DataTable({
  ...
  const [selectedColumns, setSelectedColumns] = useState(defaultColumnsSelected || columnConfigs.map((cc) => cc.key));
  const filteredColumnConfigs = columnConfigs.filter((cc) => selectedColumns.indexOf(cc.key) >= 0);
          ...
          <thead className={css(styles.thead)}>
            <tr className={css(styles.trHead)}>
              ...
              {showColumnSelector && (
                ...
                >
                  <OverlayTrigger placement="right" overlay={<Tooltip id="tooltip">Select table columns</Tooltip>}>
                    <a className={css(styles.trBodyClickable)} onClick={() => setShowColumnSelectorModal(true)}>
                      <Columns />
                    </a>
                  </OverlayTrigger>
                </th>
